...
begin
 ...
 v_window_started_at:=pg_catalog.to_timestamp(pg_catalog.floor(extract(epoch from pg_catalog.clock_timestamp())/v_window_seconds)*v_window_seconds); v_retry_after_seconds:=pg_catalog.greatest(1,v_window_seconds-pg_catalog.floor(extract(epoch from pg_catalog.clock_timestamp()-v_window_started_at))::integer);
